...
// libc P/Invoke surface for the DirectSsl transport. All TLS work is handled by the
// runtime's TlsSocketSession; this file only covers the epoll/accept/socket primitives
// that the event pump needs to drive readiness on raw file descriptors.
